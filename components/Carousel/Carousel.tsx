// A horizontal gallery on a scroll-snap track — shipped as THREE LAYERS in one
// file, so behaviour can be reused without inheriting a single pixel of look:
//
...
//   3. Carousel           the STYLED WRAPPER, rebuilt on layers 1–2: the lab
//                         demo, and the fallback for a design that drew no
//                         gallery UI of its own. When the design drew its own
//                         frame, drive THAT markup with the hook + primitives
//                         instead — the wrapper's chrome cannot wear foreign
//                         markup, and editing it costs more than authoring.
//
