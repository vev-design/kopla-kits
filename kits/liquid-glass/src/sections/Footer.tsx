...
/**
 * Structured page footer rendered as a glass shelf at the base of the
 * canvas: a translucent, blurred band with a light-reactive top hairline,
 * carrying a brand wordmark, a short blurb, columns of navigation links,
 * and a small-print line. Always the last section on the page.
 */
export interface FooterProps extends SectionBaseProps {
  /** Brand wordmark. Plain text, 1–2 words (e.g. "Halo"). */
  logo: string;
...
export function Footer({ id, logo, blurb, columns, legal }: FooterProps) {
  return (
    <section
      id={id ?? undefined}
      className="w-full border-t border-border bg-card/40 backdrop-blur-xl"
    >
...
export const FooterDemo: FooterProps = {
  logo: 'Halo',
  blurb: 'A real-time glass rendering engine for product surfaces that need to feel alive.',
  columns: [
    {
      heading: 'Product',
      links: [
  ...
  legal: '© 2026 Halo, Inc. All rights reserved.',
};
