 ...
 * small "trusted by" eyebrow. Place directly under the hero to reassure the
...
export interface LogoCloudProps extends SectionBaseProps {
  /** Small lead-in above the logos. 2–5 words, sentence case (e.g. "Trusted by teams at"). */
  eyebrow?: string | null;
...
export const LogoCloudDemo: LogoCloudProps = {
  ...
  logos: ['Lumen', 'Cedar', 'Foundry', 'Vantage', 'Helio', 'Arc'],
};
