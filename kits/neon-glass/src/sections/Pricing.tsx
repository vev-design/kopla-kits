...
/**
 * Pricing tiers as glass cards, one lifted with the hot-pink ring and glow
 * to guide the choice. Place after the testimonial, once the visitor is
 * convinced.
 */
export interface PricingProps extends SectionBaseProps {
  ...
  tiers: {
    /** Tier name. 1–2 words (e.g. "Studio", "Pro"). */
    name: string;
    /** Price figure including currency, no period. Max 8 chars (e.g. "$0", "$24", "Custom"). */
    price: string;
      ...
      <div className="mx-auto w-full max-w-6xl px-6 py-24">
        ...
        <Stagger className="grid items-start gap-6 md:grid-cols-3">
          {tiers.map((tier) => (
            <Card
              key={tier.name}
              variant={tier.highlighted ? 'highlight' : 'glass'}
...
export const PricingDemo: PricingProps = {
  ...
  subhead: 'Every plan ships the full glass system. Higher tiers unlock more scenes and seats.',
  tiers: [
    {
      name: 'Studio',
      price: '$0',
      period: 'forever',
      description: 'For solo experiments and first drops.',
      features: ['1 published scene', 'Core glass components', 'Community showcase'],
    ...
    },
    {
      ...
      price: '$24',
      period: 'per month',
      description: 'For teams launching real campaigns.',
      features: [
        'Unlimited scenes',
    ...
    },
    {
      ...
      price: 'Custom',
      period: null,
      description: 'For agencies shipping across many brands.',
      features: ['Multi-brand token sets', 'Dedicated onboarding', 'SSO & seat management'],
