      ...
      <div className="mx-auto w-full max-w-6xl px-6 py-12">
        <Reveal>
          <div className="flex flex-col items-center gap-6 rounded-2xl bg-primary px-6 py-16 text-center text-primary-foreground md:py-20">
            ...
            {body ? (
              <p data-slot="body" className="max-w-xl text-lg text-primary-foreground/80 text-pretty">
                {body}
              </p>
            ) : null}
            ...
            {note ? (
              <p data-slot="note" className="text-sm text-primary-foreground/70">{note}</p>
            ) : null}
          </div>
        </Reveal>
      </div>
