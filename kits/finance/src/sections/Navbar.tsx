 ...
 * primary account-opening call-to-action. Always the first section on the
 * page; the links jump to other sections' anchor ids via `#<id>` hrefs.
 */
export interface NavbarProps extends SectionBaseProps {
  /** Brand wordmark shown at the left. Plain text, 1–2 words, no tagline (e.g. "Meridian"). */
  logo: string;
  ...
  links: {
    ...
    label: string;
    /**
     * In-page anchor target (e.g. "#performance") or external URL.
     * @kind url
     */
    href: string;
  }[];
